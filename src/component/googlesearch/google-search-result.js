...
const searchResult = [
    {
        id: Math.ceil(Math.random() * 10), link: "https://www.websecurity.digicert.com/security-topics/what-is-ssl-tls-https",
    ...
    {
        id: Math.ceil(Math.random() * 10), link: "https://techterms.com/definition/ssl",
